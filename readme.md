...
- BioImager is A .NET microscopy imaging application based on Bio. Supports various microscopes by using imported libraries & GUI automation. Supported libraries include Zeiss® & all devices supported by python-microscope.
